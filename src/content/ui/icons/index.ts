...
export const createIconDownloadList = (className = '') => createIcon(className, '0 0 1024 1024', [{
	d: 'M160 832H864A32 32 0 1 1 864 896H160A32 32 0 1 1 160 832ZM544 578.304L780.288 341.952L825.536 387.2L508.8 704L192 387.2L237.248 341.952L480 584.704V128H544V578.304Z',
	fill: 'currentColor'
}]);

export const createIconDownloadArrow = (className = '') => createIcon(className, '0 0 1024 1024', [{
	d: 'M544 805.888V168A32 32 0 1 0 480 168V805.888L246.656 557.952A30.72 30.72 0 0 0 201.344 557.952A35.52 35.52 0 0 0 201.344 606.016L489.344 912.064A30.72 30.72 0 0 0 534.656 912.064L822.656 606.016A35.52 35.52 0 0 0 822.656 558.016A30.72 30.72 0 0 0 777.344 558.016L544 805.824Z',
	fill: 'currentColor'
}]);
